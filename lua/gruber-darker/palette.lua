...
M = {
	...
	bg = Color.new(0x101010),
	["bg+1"] = Color.new(0x181818),
	["bg+2"] = Color.new(0x282828),
	["bg+3"] = Color.new(0x453d41),
	["bg+4"] = Color.new(0x484848),
	["red-1"] = Color.new(0xc73c3f),
	red = Color.new(0xf43841),
	["red+1"] = Color.new(0xff4f58),
	green = Color.new(0x519926),
	yellow = Color.new(0xffee22),
	brown = Color.new(0xab7532),
	quartz = Color.new(0x95a99f),
	["niagara-2"] = Color.new(0x22262e),
	["niagara-1"] = Color.new(0x303540),
	niagara = Color.new(0x565f73),
